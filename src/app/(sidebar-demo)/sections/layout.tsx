...
const SidebarLayoutSection: React.FC<SidebarLayoutProps> = ({ children }) => {
  return (
    <div className="mx-6 flex flex-col md:flex-row gap-4 relative">
      <aside className="px-4 py-6 bg-secondary shadow-md rounded-md md:w-[20rem] md:max-h-[15rem] sticky top-21">
